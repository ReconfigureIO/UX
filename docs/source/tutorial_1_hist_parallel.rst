...
.. sidebar:: Make sure you're up to date.
    :subtitle: Our current version is |reco_version|
    Run ``reco version`` to check your installation. If you need to update run ``reco update`` or see our :ref:`install/update instructions <install>`.
