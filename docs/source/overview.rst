...
For more information, please see our |smi_blog| and you can check out our |examples| – we've included a version of our histogram-array code that uses SMI rather than AXI. We've also included an SMI-ready version of our `template <>`_ so you can start playing around with your own applications.

.. TODO::
    Add in link to SMI template
